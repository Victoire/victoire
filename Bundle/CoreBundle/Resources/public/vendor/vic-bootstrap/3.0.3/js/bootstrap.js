...
if (typeof $vic === "undefined") { throw new Error("Bootstrap requires $vic") }
...
+function ($vic) { "use strict";
  ...
  $vic.fn.emulateTransitionEnd = function (duration) {
...
+function ($vic) { "use strict";
  ...
  var old = $vic.fn.alert

  $vic.fn.alert = function (option) {
    return this.each(function () {
      var $victhis = $vic(this)
      var data  = $victhis.data('bs.vic-alert')

      if (!data) $victhis.data('bs.alert', (data = new Alert(this)))
      if (typeof option == 'string') data[option].call($victhis)
    })
  }

  $vic.fn.alert.Constructor = Alert


  // ALERT NO CONFLICT
  // =================

  $vic.fn.alert.noConflict = function () {
    $vic.fn.alert = old
    return this
  }
...
+function ($vic) { "use strict";
  ...
  Button.prototype.toggle = function () {
    var $vicparent = this.$vicelement.closest('[data-toggle="buttons"]')
    var changed = true
  ...
  var old = $vic.fn.button

  $vic.fn.button = function (option) {
    return this.each(function () {
      var $victhis   = $vic(this)
      var data    = $victhis.data('bs.button')
      var options = typeof option == 'object' && option

      if (!data) $victhis.data('bs.button', (data = new Button(this, options)))
  ...
  $vic.fn.button.Constructor = Button


  // BUTTON NO CONFLICT
  // ==================

  $vic.fn.button.noConflict = function () {
    $vic.fn.button = old
    return this
  }
  ...
  $vic(document).on('click.bs.button.data-api', '[data-toggle^=button]', function (e) {
...
+function ($vic) { "use strict";
  ...
  var old = $vic.fn.carousel

  $vic.fn.carousel = function (option) {
    return this.each(function () {
      var $victhis   = $vic(this)
  ...
  $vic.fn.carousel.Constructor = Carousel


  // CAROUSEL NO CONFLICT
  // ====================

  $vic.fn.carousel.noConflict = function () {
    $vic.fn.carousel = old
    return this
  }
  ...
  $vic(window).on('load', function () {
    $vic('[data-ride="carousel"]').each(function () {
      ...
      $viccarousel.carousel($viccarousel.data())
    })
  })
...
+function ($vic) { "use strict";
  ...
  var old = $vic.fn.collapse

  $vic.fn.collapse = function (option) {
    return this.each(function () {
      var $victhis   = $vic(this)
      var data    = $victhis.data('bs.vic-collapse')
      var options = $vic.extend({}, Collapse.DEFAULTS, $victhis.data(), typeof option == 'object' && option)

      if (!data) $victhis.data('bs.collapse', (data = new Collapse(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $vic.fn.collapse.Constructor = Collapse


  // COLLAPSE NO CONFLICT
  // ====================

  $vic.fn.collapse.noConflict = function () {
    $vic.fn.collapse = old
    return this
  }
  ...
  $vic(document).on('click.bs.collapse.data-api', '[data-toggle=collapse]', function (e) {
    var $victhis   = $vic(this), href
    ...
    if (!data || !data.transitioning) {
      if ($vicparent) $vicparent.find('[data-toggle=collapse][data-parent="' + parent + '"]').not($victhis).addClass('vic-collapsed')
...
+function ($vic) { "use strict";
  ...
  var Dropdown = function (element) {
    $vic(element).on('click.bs.dropdown', this.toggle)
  }
  ...
  var old = $vic.fn.dropdown

  $vic.fn.dropdown = function (option) {
    return this.each(function () {
      var $victhis = $vic(this)
      var data  = $victhis.data('bs.vic-dropdown')

      if (!data) $victhis.data('bs.dropdown', (data = new Dropdown(this)))
      if (typeof option == 'string') data[option].call($victhis)
    })
  }

  $vic.fn.dropdown.Constructor = Dropdown


  // DROPDOWN NO CONFLICT
  // ====================

  $vic.fn.dropdown.noConflict = function () {
    $vic.fn.dropdown = old
    return this
  }
...
+function ($vic) { "use strict";
  ...
  Modal.prototype.show = function (_relatedTarget) {
    var that = this
    var e    = $vic.Event('show.bs.modal', { relatedTarget: _relatedTarget })
    ...
    this.$vicelement.on('click.dismiss.modal', '[data-dismiss="modal"]', $vic.proxy(this.hide, this))
    ...
    this.backdrop(function () {
      ...
      var e = $vic.Event('shown.bs.modal', { relatedTarget: _relatedTarget })
  ...
  Modal.prototype.hide = function (e) {
    ...
    $vic(document).off('focusin.bs.modal')
    ...
    $vic.support.transition && this.$vicelement.hasClass('vic-fade') ?
      this.$vicelement
        .one($vic.support.transition.end, $vic.proxy(this.hideModal, this))
         :
      this.hideModal()
  }
  ...
  Modal.prototype.enforceFocus = function () {
    $vic(document)
      ...
      .on('focusin.bs.modal', $vic.proxy(function (e) {
  ...
  Modal.prototype.escape = function () {
    if (this.isShown && this.options.keyboard) {
      this.$vicelement.on('keyup.dismiss.bs.modal', $vic.proxy(function (e) {
        e.which == 27 && this.hide()
      }, this))
    } else if (!this.isShown) {
      this.$vicelement.off('keyup.dismiss.bs.modal')
    }
  }
  ...
  var old = $vic.fn.modal

  $vic.fn.modal = function (option, _relatedTarget) {
    return this.each(function () {
      var $victhis   = $vic(this)
      var data    = $victhis.data('bs.vic-modal')
      var options = $vic.extend({}, Modal.DEFAULTS, $victhis.data(), typeof option == 'object' && option)

      if (!data) $victhis.data('bs.modal', (data = new Modal(this, options)))
      if (typeof option == 'string') data[option](_relatedTarget)
      else if (options.show) data.show(_relatedTarget)
    })
  }

  $vic.fn.modal.Constructor = VicModal


  // MODAL NO CONFLICT
  // =================

  $vic.fn.modal.noConflict = function () {
    $vic.fn.modal = old
    return this
  }
  ...
  $vic(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
    var $victhis   = $vic(this)
  ...
  $vic(document)
    .on('show.bs.modal',  '.modal', function () { $vic(document.body).addClass('vic-modal-open') })
    .on('hidden.bs.modal', '.modal', function () { $vic(document.body).removeClass('vic-modal-open') })
...
+function ($vic) { "use strict";
  ...
  Tooltip.prototype.toggle = function (e) {
    var self = e ? $vic(e.currentTarget)[this.type](this.getDelegateOptions()).data('bs.' + this.type) : this
  ...
  var old = $vic.fn.tooltip

  $vic.fn.tooltip = function (option) {
    return this.each(function () {
      var $victhis   = $vic(this)
      var data    = $victhis.data('bs.vic-tooltip')
      var options = typeof option == 'object' && option

      if (!data) $victhis.data('bs.tooltip', (data = new Tooltip(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $vic.fn.tooltip.Constructor = Tooltip


  // TOOLTIP NO CONFLICT
  // ===================

  $vic.fn.tooltip.noConflict = function () {
    $vic.fn.tooltip = old
    return this
  }
...
+function ($vic) { "use strict";
  ...
  if (!$vic.fn.tooltip) throw new Error('Popover requires tooltip.js')

  Popover.DEFAULTS = $vic.extend({} , $vic.fn.tooltip.Constructor.DEFAULTS, {
    placement: 'right'
  , trigger: 'click'
  , content: ''
  ...
  Popover.prototype = $vic.extend({}, $vic.fn.tooltip.Constructor.prototype)
  ...
  var old = $vic.fn.popover

  $vic.fn.popover = function (option) {
    return this.each(function () {
      var $victhis   = $vic(this)
      var data    = $victhis.data('bs.vic-popover')
      var options = typeof option == 'object' && option

      if (!data) $victhis.data('bs.popover', (data = new Popover(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $vic.fn.popover.Constructor = Popover


  // POPOVER NO CONFLICT
  // ===================

  $vic.fn.popover.noConflict = function () {
    $vic.fn.popover = old
    return this
  }
...
+function ($vic) { "use strict";
  ...
  var old = $vic.fn.scrollspy

  $vic.fn.scrollspy = function (option) {
    return this.each(function () {
      var $victhis   = $vic(this)
      var data    = $victhis.data('bs.scrollspy')
      var options = typeof option == 'object' && option

      if (!data) $victhis.data('bs.scrollspy', (data = new ScrollSpy(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $vic.fn.scrollspy.Constructor = ScrollSpy


  // SCROLLSPY NO CONFLICT
  // =====================

  $vic.fn.scrollspy.noConflict = function () {
    $vic.fn.scrollspy = old
    return this
  }
...
+function ($vic) { "use strict";
  ...
  $vic.fn.tab = function ( option ) {
    return this.each(function () {
      var $victhis = $vic(this)
      var data  = $victhis.data('bs.tab')

      if (!data) $victhis.data('bs.tab', (data = new Tab(this)))
      if (typeof option == 'string') data[option]()
    })
  }

  $vic.fn.tab.Constructor = Tab


  // TAB NO CONFLICT
  // ===============

  $vic.fn.tab.noConflict = function () {
    $vic.fn.tab = old
    return this
  }
  ...
  $vic(document).on('click.bs.tab.data-api', '[data-toggle="tab"], [data-toggle="pill"]', function (e) {
    e.preventDefault()
    $vic(this).tab('show')
  })
...
+function ($vic) { "use strict";
  ...
  var old = $vic.fn.affix

  $vic.fn.affix = function (option) {
    return this.each(function () {
      var $victhis   = $vic(this)
      var data    = $victhis.data('bs.vic-affix')
      var options = typeof option == 'object' && option

      if (!data) $victhis.data('bs.affix', (data = new Affix(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }

  $vic.fn.affix.Constructor = Affix


  // AFFIX NO CONFLICT
  // =================

  $vic.fn.affix.noConflict = function () {
    $vic.fn.affix = old
    return this
  }
