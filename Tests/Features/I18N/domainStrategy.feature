...
Background:
    Given I am on "http://fr.victoire.dev:8000/app_domain.php/login"
    When I fill in "email" with "anakin@victoire.io"
    And I fill in "password" with "test"
    And I press "Embarquer"
    Then I should be on "http://fr.victoire.dev:8000/app_domain.php/"
...
Scenario: I can create a page in two languages
    ...
    And I should be on "http://fr.victoire.dev:8000/app_domain.php/page-francaise"
    ...
    And I fill in "URL" with "english-page"
    And I follow "Mettre à jour"
    And I wait 7 seconds
    Then I should be on "http://en.victoire.dev:8000/app_domain.php/english-page"