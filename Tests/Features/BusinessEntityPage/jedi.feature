...
Feature: Manage jedis
    ...
    Scenario: I can rename the url of a jedi
        ...
        When I fill in "business_template_translations_fr_slug" with "Dark Vador"
        Then I should see an ".business_template_translations_fr_a2lix_translationsFields-fr .slug-is-correct.vic-hidden" element
        And I should not see an ".business_template_translations_fr_a2lix_translationsFields-fr .slug-is-not-correct.vic-hidden" element
        When I fill in "business_template_translations_fr_slug" with ""
        Then I should not see an ".business_template_translations_fr_a2lix_translationsFields-fr .slug-is-not-correct.vic-hidden" element
        And I should see an ".business_template_translations_fr_a2lix_translationsFields-fr .slug-is-correct.vic-hidden" element
        When I fill in "business_template_translations_fr_slug" with "dark-vador"
        Then I should not see an ".business_template_translations_fr_a2lix_translationsFields-fr .slug-is-correct.vic-hidden" element
        And I should see an ".business_template_translations_fr_a2lix_translationsFields-fr .slug-is-not-correct.vic-hidden" element
